...
Далее, создаём диагональную матрицу из отобранных вершин и фильтруем рёбра через умножение полученной матрицы на марицу, хранящую соответствующий тип рёбер.
